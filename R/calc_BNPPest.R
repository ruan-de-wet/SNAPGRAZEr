...
#' @param ANPPt_est (equivalent to Pg) Total seasonal grass production for the given grazing management system. Output of calc_ANPPest() or calc_Pg().
...
#' @param bnpp_c Default = 0.602.
#' @export

calc_BNPPest = function(
  RAIN,
  MAT,
  ANPPt_est,
  Sk,
  ...
  BNPPest = (bnpp_c * RAIN - 0.00038 * RAIN^2 + 5.88 * MAT) *
    (ANPPt_est / (Sk - S0)) *
    APC *
    (DEPTH / 40)
  return(BNPPest)
